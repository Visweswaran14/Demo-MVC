...
namespace Dotnet2.Controllers
{
    ...
    {
        private readonly Class2Context _context;

        public EmployeesController(Class2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Employees != null ? 
                          ...
                          Problem("Entity set 'Class2Context.Employees'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Class2Context.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
